...
type LevelDBConfig struct {
	...
	CompactionTableSizeMultiplier int  `toml:"compaction_table_size_multiplier"`
}
...
func (cfg *LevelDBConfig) adjust() {
	...
	cfg.CompactionTableSizeMultiplier = getDefault(1, cfg.CompactionTableSizeMultiplier)
}
